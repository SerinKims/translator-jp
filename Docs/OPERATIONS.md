...
| Ollama 서버 미실행 | Ollama 서버에 연결할 수 없습니다. 로컬에서 Ollama가 실행 중인지 확인해주세요. | `OLLAMA_CONNECTION_ERROR` |
| 모델 없음 | qwen3:14b 모델을 찾을 수 없습니다. ollama pull qwen3:14b 명령어로 모델을 설치해주세요. | `OLLAMA_MODEL_NOT_FOUND` |
